...
import com.example.android.background.utilities.WorkerUtilities;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //MyWorker myWorker=new MyWorker(this,null);
        ...
        .setConstraints(WorkerUtilities.getInstance().getConstraints())
        .build();
